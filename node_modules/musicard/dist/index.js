...
var Classic = async (option) => {
  ...
  let thumbnail;
  try {
    thumbnail = await (0, import_canvas2.loadImage)(await (0, import_cropify.cropImage)({
    ...
    <rect y="565" width="1568" height="272" rx="50" fill="${option.backgroundColor}"/>
      ...
      try {
        ...
        await (0, import_cropify.cropImage)({
          ...
          ctx.drawImage(await (0, import_canvas2.loadImage)(x), 0, 0);
        });
        await (0, import_cropify.cropImage)({
          imagePath: image,
          x: 0,
          ...
          ctx.drawImage(await (0, import_canvas2.loadImage)(x), 0, 565);
        });
...
var ClassicPro = async (option) => {
  ...
  let thumbnail;
  try {
    thumbnail = await (0, import_canvas3.loadImage)(await (0, import_cropify2.cropImage)({
      imagePath: option.thumbnailImage,
      borderRadius: 50,
      width: 331,
      height: 331,
...
var Dynamic = async (option) => {
  ...
  let thumbnail;
  try {
    thumbnail = await (0, import_canvas4.loadImage)(await (0, import_cropify3.cropImage)({
      imagePath: option.thumbnailImage,
      borderRadius: 210,
      width: 400,
      height: 400,
  ...
  try {
    ...
    if (!option.backgroundImage) {
      ...
      try {
        ...
        const image = await (0, import_cropify3.cropImage)({
          imagePath: option.backgroundImage,
          width: 2367,
          height: 520,
          borderRadius: 270,
        ...
        const darkImage = await (0, import_cropify3.cropImage)({
        ...
        ctx.drawImage(await (0, import_canvas4.loadImage)(image), 0, 0);
        ctx.drawImage(await (0, import_canvas4.loadImage)(darkImage), 0, 0);
      } catch (error) {
        const backgroundSvg = generateSvg(`<svg width="2367" height="520" viewBox="0 0 2367 520" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 260C0 116.406 116.406 0 260 0H2107C2250.59 0 2367 116.406 2367 260V260C2367 403.594 2250.59 520 2107 520H260C116.406 520 0 403.594 0 260V260Z" fill="${option.backgroundColor}"/>
                </svg>`);
...
var Mini = async (option) => {
  ...
  let thumbnail;
  try {
    thumbnail = await (0, import_canvas5.loadImage)(await (0, import_cropify4.cropImage)({
      imagePath: option.thumbnailImage,
      borderRadius: 50,
      width: 544,
      height: 544,
